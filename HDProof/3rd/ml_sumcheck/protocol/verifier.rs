...
use crate::protocol::prover::ProverMsg;
use crate::protocol::IPForMLSumcheck;
use ark_ff::Field;
...
impl<F: Field> IPForMLSumcheck<F> {
    ...
    pub fn check_and_generate_subclaim(
        ...
        asserted_sum: F,
    ) -> Result<SubClaim<F>, super::super::Error> {
        if !verifier_state.finished {
        ...
        for i in 0..verifier_state.nv {
            ...
            if p0 + p1 != expected {
                return Err(super::super::Error::Reject(Some(
...
#[cfg(test)]
mod test {
    use crate::protocol::verifier::interpolate_uni_poly;
