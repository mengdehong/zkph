# Swin Transformer implementation adapted from official repository  
# Original source: https://github.com/microsoft/Swin-Transformer
...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        x_size = self.patch_embed.patches_resolution
        for layer in self.layers:
            x = layer(x, x_size)
            # 如果这个 layer 有 downsample，则更新 x_size
